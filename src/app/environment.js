      ...
      (importedMesh) => {
        switch (importedMesh.name) {
          case "LowerGallery":
            ...
            this.app.loaders.items.LowerGalleryNormal.encoding =
          ...
          case "UpperGallery":
            ...
            this.app.loaders.items.LowerGalleryRough.encoding =
              THREE.LinearEncoding;
            shadow = true;
            break;
          ...
          case "GalleryPedestalsThirdInSide":
            parameters = {
              map: this.app.loaders.items.PedestalDiffuse,
              roughness: 0.5,
            };
        ...
        if (!parameters.color && !parameters.map) {
          if (trans) {
            let transMaterial = new THREE.MeshBasicMaterial({
              color: 0xfffffff,
              transparent: true,
              opacity: 0,
            });
